...
--
ALTER TABLE `pagamenti`
  ADD CONSTRAINT `pagamenti_pagante_id_foreign` FOREIGN KEY (`pagante_id`) REFERENCES `paganti` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pagamenti_prenotazione_id_foreign` FOREIGN KEY (`prenotazione_id`) REFERENCES `prenotazioni` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `paganti`
--
ALTER TABLE `paganti`
  ADD CONSTRAINT `paganti_ospite_id_foreign` FOREIGN KEY (`ospite_id`) REFERENCES `ospiti` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `prenotazioni`
--
ALTER TABLE `prenotazioni`
  ADD CONSTRAINT `prenotazioni_configurazione_id_foreign` FOREIGN KEY (`configurazione_id`) REFERENCES `configurazioni` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `prenotazioni_stanza_id_foreign` FOREIGN KEY (`stanza_id`) REFERENCES `stanze` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `prenotazioni_has_ospiti`
--
ALTER TABLE `prenotazioni_has_ospiti`
  ADD CONSTRAINT `prenotazioni_has_ospiti_ospite_id_foreign` FOREIGN KEY (`ospite_id`) REFERENCES `ospiti` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `prenotazioni_has_ospiti_prenotazione_id_foreign` FOREIGN KEY (`prenotazione_id`) REFERENCES `prenotazioni` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
